...
class I10n_MO extends I10n_GettextTranslations {
	...
	function import_from_file($filename) {
		$reader = new I10n_FileReader($filename);
	...
	function import_from_reader($reader) {
		$endian_string = I10n_MO::get_byteorder($reader->readint32());
	...
	/**
	 * Build a Entry from original string and translation strings,
	 * found in a MO file
	 *
	 * @static
