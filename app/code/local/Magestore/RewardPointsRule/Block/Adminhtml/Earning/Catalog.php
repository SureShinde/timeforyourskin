...
class Magestore_RewardPointsRule_Block_Adminhtml_Earning_Catalog extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    public function linkApply() {
        $link = Mage::getSingleton('adminhtml/url')->getUrl('rewardpointsruleadmin/adminhtml_earning_catalog/showApplyRule', array(
    ...
    public function actionApplly() {
        $link = Mage::getSingleton('adminhtml/url')->getUrl('rewardpointsruleadmin/adminhtml_earning_catalog/applyRuleAjax', array(
