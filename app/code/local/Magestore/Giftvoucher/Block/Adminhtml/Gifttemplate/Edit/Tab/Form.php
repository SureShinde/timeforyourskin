...
class Magestore_Giftvoucher_Block_Adminhtml_Gifttemplate_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $pattern = $data['design_pattern'] ? $data['design_pattern'] : 1;
        $fieldset->addField('design_pattern', 'select', array('label' => Mage::helper('giftvoucher')->__('Template design'),
            ...
            'after_element_html' => '
                <div id="demo_pattern" style="left: 530px;position: absolute;"><img id="pattern_demo" style="width:500px" src="' . Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . 'giftvoucher/template/pattern/GC_' . $pattern . '.jpg' . '" /> <div>'
