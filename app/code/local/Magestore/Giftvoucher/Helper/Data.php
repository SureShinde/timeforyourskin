...
//        );
    ...
    public function convertNotes($notes) {
        $notes = str_replace(array(
            ...
            '<a href="' . Mage::app()->getStore($this->getStoreId())->getBaseUrl() . '">' . Mage::app()->getStore($this->getStoreId())->getBaseUrl() . '</a>',
    ...
    public function createBarcode($gift_code) {
        ...
        $imageObj->resize($imageObj->getOriginalWidth() + 8, 50);
        $imageObj->save($imageUrl);
    }
