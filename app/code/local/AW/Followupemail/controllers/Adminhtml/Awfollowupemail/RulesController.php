...
class AW_Followupemail_Adminhtml_Awfollowupemail_RulesController extends Mage_Adminhtml_Controller_Action
{
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                if ($this->getRequest()->getParam('sendTest')) {
                    ...
                    if ($testResult) {
                        $mailLogUrl = Mage::getModel('adminhtml/url')->getUrl('adminhtml/awfollowupemail_queue');
                        $session->addSuccess(
                            $this->__(
