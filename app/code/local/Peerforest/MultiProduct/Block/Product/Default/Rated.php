...
class Peerforest_MultiProduct_Block_Product_Default_Rated extends Mage_Catalog_Block_Product_List
{
    protected function _getProductCollection()
    {
        ...
        // your custom filter
            ...
            //                       'left');
            $collection->joinField('rating_summary', 'review/review_aggregate', 'rating_summary',
                                           'entity_pk_value=entity_id',  array('entity_type' => 1,
                                            'store_id' => Mage::app()->getStore()->getId()), 'left');                
