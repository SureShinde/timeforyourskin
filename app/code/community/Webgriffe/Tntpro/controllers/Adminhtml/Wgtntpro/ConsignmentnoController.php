...
class Webgriffe_Tntpro_Adminhtml_Wgtntpro_ConsignmentnoController extends Mage_Adminhtml_Controller_Action {
    ...
    public function requestManifestAction()
    {
        ...
        if ( Mage::helper('wgtntpro')->sendMail($csv) ) {
            Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('wgtntpro')->__('An Email was sent to TNT'));
        } else {
