...
class Webgriffe_Tntpro_Block_Adminhtml_Newshipment extends Mage_Adminhtml_Block_Template {
    ...
    public function getOperationOption($address){
        return Mage::getModel('wgtntpro/point_address')->loadByOrderAddressId($address->getId())->getOperationalType();
    }
    public function getOperationOptionCode($address){
        return Mage::getModel('wgtntpro/point_address')->loadByOrderAddressId($address->getId())->getOperationalCode();
    }
